...
- **`learn`** — SWE 전문성 증진·커리어 스킬 전환·새 패러다임(DDD·ES/CQRS·리질리언스) 습득은 `learn`의 `deliberate-practice`·`metalearning`·`spaced-repetition`. 매뉴얼 읽기·책 완독이 아닌 *실전 적용 + 피드백 루프* 설계가 필요할 때.
